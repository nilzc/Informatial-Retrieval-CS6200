...
# this is a test program to run on mock data, to make sure the algorithm is correct
...
class WT2G:
    ...
    def print_top_500(self):
        ...
        with open('./wt2g_inlinks/page_rank.txt', "a") as f:
...
wt2g = WT2G("./wt2g_inlinks/wt2g_inlinks.txt")
wt2g.get_page_rank()
wt2g.print_top_500()
